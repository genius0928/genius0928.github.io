...
![500](/assets/img/20240108/why-tomany-default-lazy.png){:width="600px"}  
...
SQL에서 Join은 크게 두가지가 있다. [SQL의 조인](https://blog.huni.kr/posts/SQL의-조인) 참고.
...
![300](/assets/img/20240108/no-comment-save.png){:width="300px"}  
